...
gt_ann = '/scratch/jliang12/data/ASUMayoDBsplit_jpg/annotations/test_detc_annotations_coco.json'
pr_ann = '/data/jliang12/shared/ssenth21/toma/org-dino-pipeline/detection/asumayopolyp/ASUMayoDBPolyp_detection_variant_4_run_01_evaltest_pred_results_testset/results0.json'
root_dir = '/scratch/ssenth21/coco-froc-analysis/data/swin_dino_asumayo_polyp/unofficial_test_set'
