...
gt_ann = '/scratch/ssenth21/VinDr-CXR/physionet.org/files/vindr-cxr/1.0.0/annotations/annotations_test_all_zerosbbox.json'
pr_ann = '/data/jliang12/ssenth21/bench_boost_localizers/experiments/exp_1/DINO/Swin/finetune_vindr/run02/vindr_ft_test_preds.bbox.json'
root_dir = '/data/jliang12/ssenth21/bench_boost_localizers/experiments/exp_1/DINO/Swin/finetune_vindr/run02/froc_curves'

for iou_thres_val in [0.4]:
