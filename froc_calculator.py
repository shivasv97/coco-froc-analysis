...
pr_ann = '/scratch/ssenth21/InternImage/detection/results/faster_rcnn_1_kaggle_.bbox.json'
root_dir = '/scratch/ssenth21/coco-froc-analysis/data/faster_rcnn_vindr/kaggle_test_normal_froc_only'
