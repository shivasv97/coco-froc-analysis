...
gt_ann = '/scratch/jliang12/data/VinDr-CXR/physionet.org/files/vindr-cxr/1.0.0/annotations/vindrcxr_test_OrganDetection.json'
pr_ann = '/data/jliang12/shared/ssenth21/toma/org-dino-pipeline/detection/vindr_org_loc/SwinB_IN22k_variant_1_vindr_org_loc_run01_eval_2/cocoeval_pred.json'
root_dir = '/scratch/ssenth21/coco-froc-analysis/data/swin_dino_vindr_org_det/test_set_cocoeval_run_2'
