...
gt_ann = '/scratch/jliang12/data/ASUMayoDBsplit_jpg/annotations/val_detc_annotations_only_disease_coco.json'
pr_ann = '/data/jliang12/shared/ssenth21/toma/org-dino-pipeline/detection/asumayopolyp/ASUMayoDBPolyp_swinB_detection_scene_1_run_01_eval/cocoeval_pred.json'
root_dir = '/scratch/ssenth21/coco-froc-analysis/data/swin_dino_asumayo_polyp/validation_set/scene_1_swinB_run_2'
