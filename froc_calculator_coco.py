...
pr_ann = '/data/jliang12/ssenth21/bench_boost_localizers/experiments/exp_0/DINO/Swin/Evaluate_pretrained_published/run02/coco_val_preds.bbox.json'
root_dir = '/data/jliang12/ssenth21/bench_boost_localizers/experiments/exp_0/DINO/Swin/Evaluate_pretrained_published/run02/froc_curves'
